...
def build_translate_title_user_prompt(title: str, abstract: str) -> str:
    return f"""你是一位精通多种语言的专业翻译，能够准确地将英文输入翻译成简体中文。翻译时，请保留原文的语气、风格和表达方式。
